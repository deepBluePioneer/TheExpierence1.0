local Ceilling = {}
Ceilling.__index = Ceilling



function Ceilling.new(modelParent, tilesFolder, gridCells)
    local self = setmetatable({}, Ceilling)
...
function Ceilling:generateCeilling(numTilesX, numTilesZ )
    ...
    for x = 1, numTilesX do
        for z = 1, numTilesZ do
            ...
            tile.Position = Vector3.new(self.gridCells[x][z].Position.x,ceillingHeight , self.gridCells[x][z].Position.z)
