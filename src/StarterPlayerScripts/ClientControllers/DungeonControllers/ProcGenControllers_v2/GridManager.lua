    ...
    for i = 0, gridSize - 1 do
        ...
        for j = 0, gridSize - 1 do
            ...
            gridCells[i][j] = {
                ...
                -- Room Corner properties
                Corner_Northwest = false,
                Corner_Northeast = false,
                Corner_Southwest = false,
                Corner_Southeast = false,

                -- Perimeter properties
                Perimeter_North = false,
                Perimeter_East = false,
                Perimeter_West = false,
                Perimeter_South = false,

                --Path Corner Properties
                 NorthRightTurn = false,
                 NorthLeftTurn = false,
                 SouthRightTurn = false,
                 SouthLeftTurn = false,
            
                 -- Path Corridor Properties
                 VerticalCorridor = false,
                 HorizontalCorridor = false,
                
                 --Entry Cell
                 Perimeter_WallPart = nil,
                 Corridor_WallPart = nil
