...
local Node = require(CustomPackages.GraphModules.Graphoon.Node)

local Edge = require(CustomPackages.GraphModules.Graphoon.Edge)
local List = require(CustomPackages.GraphModules.list_a);
